...
export const PERSONAL_INFO = {
  ...
  subCatchphrase: "泥臭い行動量と、緻密なデータ分析。\n製造業のDXを加速させる、次世代のビジネス開発。",
...
export const METRICS_DATA: MetricItem[] = [
  {
    ...
    subValue: "Avg 3.0%",
    growth: "+290%",
    description: "徹底した事前リサーチと仮説構築により、業界平均を大きく上回るアポイント獲得率を達成。"
  },
  {
    id: "2",
    label: "受注貢献額 (Revenue)",
    value: "¥50.0M",
    growth: "6ヶ月間",
    description: "インターン期間中、エンタープライズ企業を含む3社のPoC導入から本契約までをリード。"
  },
  {
    id: "3",
    label: "行動量 (Action)",
    value: "3,600+",
    growth: "Calls",
    description: "質を担保するための圧倒的な量。断られることを恐れず、市場の声を拾い続けました。"
  }
];
...
export const PROCESS_STEPS: ProcessStep[] = [
  {
    ...
    description: "顧客のIR情報や業界ニュースを徹底的に分析。「まだ顧客自身も気づいていない課題」を仮説立てします。",
    icon: "search"
  },
  {
    id: 2,
    title: "Approach (アプローチ)",
    description: "テンプレート通りの架電はしません。仮説をぶつけ、担当者が「話を聞いてみたい」と思える問いかけを行います。",
    icon: "message"
  },
  {
    id: 3,
    title: "Co-creation (課題共創)",
    description: "製品を売るのではなく、PoCを通じて顧客と共に「成功の定義」を設計。現場レベルの運用フローまで落とし込みます。",
    icon: "handshake"
  },
  {
    id: 4,
    title: "Success (成果創出)",
    description: "導入後の定着化支援まで見据え、LTV（顧客生涯価値）を最大化する提案を行います。",
    icon: "rocket"
  }
];
...
export const EXPERIENCE_DATA: ExperienceItem[] = [
  {
    ...
    skills: ["Inside Sales", "Field Sales", "Account Management", "CRM運用設計", "Lead Nurturing"]
  },
  {
    category: "Tools & Tech",
